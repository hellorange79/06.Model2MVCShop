		...
		<form name="detailForm" action="/listProduct.do?menu=${param.menu}"
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr class="ct_list_pop">
					...
					<a href="/updateProductView.do?menu=${param.menu}&prodNo=${product.prodNo}">${product.prodName}</a>
					</c:if>
					<c:if test="${param.menu eq 'search'}">
					<a href="/getProduct.do?menu=${param.menu}&prodNo=${product.prodNo}">${product.prodName}</a></c:if></td>
